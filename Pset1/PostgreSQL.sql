...
('33344555587', 'Fernando', 'T', 'Wong', '08-12-1955', 'Rua da Lapa, 34, São Paulo, SP', 'M', '40000', '88866555576', '5' ),
('99988777767', 'Alice', 'J', 'Zelaya', '19-01-1968', 'Rua Souza Lima, 35,Curitiba,PR', 'F', '25000', '98765432168', '4'),
('98765432168', 'Jennifer', 'S', 'Souza', '20-06-1941', 'Av. Arthur de Lima, 54, Santo André, SP', 'F', '43000', '88866555576', '4'),
('66688444476', 'Ronaldo', 'K', 'Lima', '15-09-1962', 'Rua Rebouças, 65, Piracicaba, SP', 'M', '38000', '33344555587', '5'),
('45345345376', 'Joice', 'A', 'Leite', '31-07-1972', 'Av. Lucas Obes, 74, São Paulo, SP', 'F', '25000', '33344555587', '5'),
('98798798733', 'André', 'V', 'Pereira', '29-03-1969', 'Rua Timbira, 35, São Paulo, SP', 'M', '25000', '98765432168', '4'),
('88866555576', 'Jorge', 'E', 'Brito', '10-11-1937', 'Rua do Horto, 35, São Paulo, SP', 'M', '55000', '88866555576', '1');
...
('1', 'Matriz', '88866555576', '19-06-1981');
...
ALTER TABLE elmasri.funcionario ADD CONSTRAINT funcionario_sexo_check
check (sexo in ('M', 'F'));

ALTER TABLE elmasri.funcionario ADD CONSTRAINT funcionario_salario_check
check (salario > 0);

ALTER TABLE elmasri.funcionario ADD CONSTRAINT funcionario_numero_departamento_check
...
ALTER TABLE elmasri.dependente ADD CONSTRAINT dependente_sexo_check
check (sexo in ('M', 'F'));
...
ALTER TABLE elmasri.departamento ADD constraint departamento_numero_departamento_check
check (numero_departamento > 0);
...
ALTER TABLE elmasri.trabalha_em ADD CONSTRAINT trabalha_em_numero_projeto_check
check (numero_projeto > 0);

ALTER TABLE elmasri.trabalha_em ADD CONSTRAINT trabalha_em_horas_check
check (horas >= 0);
...
ALTER TABLE elmasri.localizacoes_departamento ADD CONSTRAINT localizacoes_departamento_numero_departamento_check
check (numero_departamento > 0);
...
ALTER TABLE elmasri.projeto ADD CONSTRAINT projeto_numero_projeto_check
check (numero_projeto > 0);

ALTER TABLE elmasri.projeto ADD CONSTRAINT projeto_numero_departamento_check
check (numero_departamento > 0);
